 ...
 */
export default class CocosCreator implements sgmed.SceneExporter {
    /**
     ...
     */
    protected createLocalResourceMap(assetFileMap: sgmed.AssetFileMap): Map<string, ResourceMapEntity>;
    /**
