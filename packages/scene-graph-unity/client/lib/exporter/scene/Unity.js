...
var Unity = /** @class */ (function () {
     ...
     */
    Unity.prototype.loadSceneFile = function (sceneFile) {
        var _this = this;
        var components = {};
    ...
    Unity.prototype.collectChildSceneFiles = function (scene) {
        var childSceneFiles = [];
     ...
     */
    Unity.prototype.createSceneGraph = function (json) {
        var graph = {
            scene: [],
            metadata: {
                width: 0,
     ...
     */
    Unity.prototype.pluginPostProcess = function (graph, sceneJson, assetFileMap, plugins) {
        if (!plugins) {
            return;
        }
     ...
     */
    Unity.prototype.createGuidMap = function (assetFileMap) {
        var guidMap = new Map();
    ...
    Unity.prototype.addUnityAssetFiles = function (scene) {
        var _this = this;
        Object.entries(scene).forEach(function (array) {
            var entity = array[1];
            switch (entity.componentName) {
    ...
    Unity.prototype.addUnityAssetFile = function (entity, key) {
        var _this = this;
    ...
    Unity.prototype.appendComponents = function (scene, graph) {
        var _this = this;
