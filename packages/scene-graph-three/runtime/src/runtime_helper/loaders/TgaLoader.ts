...
export default class TgaLoader implements ThreeLoader {
  ...
  // TGA constants
    ...
    constructor(manager?: any) {
        this.manager = ( manager !== undefined ) ? manager : TgaLoader.threeRef.DefaultLoadingManager;
    }
    load(url: string, onLoad?: any, onProgress?: any, onError?: any) {
        var scope = this;

        var texture = new TgaLoader.threeRef.Texture();

        var loader = new TgaLoader.threeRef.FileLoader( this.manager );
